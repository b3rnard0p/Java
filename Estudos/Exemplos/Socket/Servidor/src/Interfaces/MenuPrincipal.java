...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        MenuItemCada3 = new javax.swing.JMenuItem();
        MenuRela = new javax.swing.JMenu();
        MenuItemRela = new javax.swing.JMenuItem();
        MenuItemRela2 = new javax.swing.JMenuItem();
        ...
        MenuItemCada3.setText("Formulário");
        MenuItemCada3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MenuItemCada3ActionPerformed(evt);
            }
        });
        MenuCada.add(MenuItemCada3);
        ...
        MenuItemRela2.setText("Relatório de veículos");
        MenuItemRela2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MenuItemRela2ActionPerformed(evt);
            }
        });
        MenuRela.add(MenuItemRela2);
    ...
    private void MenuItemCada3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MenuItemCada3ActionPerformed
        Formulario form = new Formulario();
        form.setVisible(true); 
    }//GEN-LAST:event_MenuItemCada3ActionPerformed

    private void MenuItemRela2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MenuItemRela2ActionPerformed
        RelatorioVeiculos relVeiculo = new RelatorioVeiculos();
        relVeiculo.setVisible(true);
    }//GEN-LAST:event_MenuItemRela2ActionPerformed
    ...
    private javax.swing.JMenuItem MenuItemCada3;
    private javax.swing.JMenuItem MenuItemRela;
    private javax.swing.JMenuItem MenuItemRela2;
