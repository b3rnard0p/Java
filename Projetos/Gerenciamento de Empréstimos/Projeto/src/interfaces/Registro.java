...
public class Registro extends javax.swing.JFrame {
    ...
    private void BtnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRegistrarActionPerformed
        ...
        Emprestimo ultimoEmprestimo = eDAO.verificarEstadoUltimoEmprestimo(itemSelecionado.getId());

        if (estado.equals("emprestado") && (ultimoEmprestimo != null && ultimoEmprestimo.getEstado().equals("emprestado"))) {
            JOptionPane.showMessageDialog(this, "Este item já está emprestado!", "Erro", JOptionPane.ERROR_MESSAGE);
            return;
        } else if (estado.equals("devolvido") && (ultimoEmprestimo == null || ultimoEmprestimo.getEstado().equals("devolvido"))) {
            JOptionPane.showMessageDialog(this, "Este item já está devolvido!", "Erro", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        if (Rda_BtnEmprestimo.isSelected()) {
            ...
            ultimoEmprestimo.setEstado("devolvido");
            eDAO.editar(ultimoEmprestimo);
        }
